package com.hsc.mystep.controller.service;
...
import com.hsc.mystep.activity.MainActivity;
import com.hsc.mystep.controller.accelerometer.StepCount;
import com.hsc.mystep.controller.accelerometer.StepValuePassListener;
...
public class StepService extends Service implements SensorEventListener{
    ...
    private void initNotification() {
        ...
        mBuilder.setContentTitle(getResources().getString(R.string.app_name))
                ...
                .setAutoCancel(false) //设置这个标志用户单击面板就可以让通知将自动取消
                .setOngoing(true) //设置它为一个正在进行的通知。通常用来表示一个后台任务，
        ...
        mBatInfoReceiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                if (Intent.ACTION_SCREEN_ON.equals(action)){
                    ...
                    Log.i(TAG, " receive Intent.ACTION_SHUTDOWN");
                    save();
    ...
    private void isNewDay() {
        String time = "00:00";
        if (time.equals(new SimpleDateFormat("HH:mm").format(new Date())) || !CURRENT_DATE.equals(getTodayData())) {
            initTodayDate();
        }
    }
    ...
    private void remindNotify() {
        ...
        builder.setContentTitle("今日步数" + CURRENT_STEP + "步")
                ...
                .setContentIntent(pendingIntent)
                .setTicker(getResources().getString(R.string.app_name) + "提醒你锻炼了")//通知首次出现在通知栏，带上升动画效果的
                .setWhen(System.currentTimeMillis())//通知产生的时间，会在通知信息里显示
                .setPriority(Notification.PRIORITY_DEFAULT)//设置通知栏优先级
                .setAutoCancel(true) // 用户单击通知面板就可以自动取消
        ...
        manager.notify(notify_remind_id, builder.build());
    }
    ...
    public void onSensorChanged(SensorEvent sensorEvent) {
        if (stepSensorType == Sensor.TYPE_STEP_COUNTER) {
            ...
            // 首次如果没有获取手机系统中已有的步数则获取一次系统中APP还未开始计步的步数
            if (!hasRecord) {
                hasRecord = true;
